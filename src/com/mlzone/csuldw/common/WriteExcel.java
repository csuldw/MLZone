...
public class WriteExcel
{
	...
	public InputStream export() throws Exception
	{
		...
		// sheet.setDefaultRowHeightInPoints(30); 				//设置每行的默认高度
		...
		rowRowName.setHeightInPoints((short) (25)); 			// 设置标题行高度
		...
		for (int colNum = 0; colNum < columnNum; colNum++)
		{
			...
			if (colNum == 0)
			{
				...
				sheet.setColumnWidth(colNum, (columnWidth + 3) * 256);
			} else
			{
				// sheet.setDefaultRowHeight((short) 13);
	...
	public static void write(String path, String filename, InputStream in)
	{
		...
		try
		{
			...
			os.flush();
			System.out.println("Export excel, filepath: " + excelPath);
		} 
		catch (Exception e)
		{
			e.printStackTrace();
	...
	public static void main(String[] args) throws Exception
	{
		...
		obj1[0] = "1";
		obj1[1] = "2017/07/04 10:23";
		obj1[2] = ma.get("b");
		obj1[3] = ma.get("2") == null ? "1" : "f";
		obj1[4] = "wsz";
		obj1[5] = "wsz";
		dataList.add(obj1);
		...
		WriteExcel.write("D://temp", "fdsf.xls", is);
	}
}
